...
--}}
    ...
    <!--Estilos para vista VER CLIENTES-->
    <link type="text/css" rel="stylesheet" href="/css/dashboard/fullcalendar.min.css"/>
    <link type="text/css" rel="stylesheet" href="/css/dashboard/timeline2.css"/>
...
<!-- Estilos para vista VER PROYECTO TABLA COTIZACIONES-->
...
<!--Fin de Scripts para el switch-->
<!--end of plugin scripts-->
<!--Page level scripts-->
<script type="text/javascript" src="/js/dashboard/users.js"></script>
<script type="text/javascript" src="/js/dashboard/p_notify.js"></script>
<script type="text/javascript" src="/js/dashboard/radio_checkbox.js"></script>
<!-- end page level scripts -->
<!--Scripts para viste VER CLIENTE-->
<script type="text/javascript" src="/js/dashboard/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="/js/dashboard/jasny-bootstrap.min.js"></script>
<script type="text/javascript" src="/js/dashboard/bootstrap_calendar.min.js"></script>
...
<script type="text/javascript" src="/js/dashboard/mini_calendar.js"></script>
    ...
    <script type="text/javascript" src="/js/dashboard/jquery-clockpicker.min.js"></script>
    <!--end of plugin scripts-->
    <script type="text/javascript" src="/js/dashboard/form.js"></script>
