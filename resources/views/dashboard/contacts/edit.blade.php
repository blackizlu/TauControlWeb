            ...
            <div class="inner bg-container">
                <div class="card">
                    <div class="card-block ">
                        ...
                        @endif
                        <form class="form-horizontal login_validator" id="tryitForm" action="{{ route('dashboard.contacts.update', $contact->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row m-t-25">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="contact_name" id="u-name" value=" {{ $contact->contact_name }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder=" " id="phone_number" name="phone_number" value="{{ $contact->phone_number }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder=" " id="workstation" name="workstation" value="{{ $contact->workstation }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <input type="text" placeholder=" " id="email" name="email" value="{{ $contact->email }}" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-xl-6 col-lg-8">
                                            <div class="input-group">
                                                ...
                                                <select class="form-control chzn-select" tabindex="2" name="client_id" value="{{$contact->client_id}}">
                                                    <option value="{{$contact->client_id}}" selected>{{$contact->client->client_name}}</option>
