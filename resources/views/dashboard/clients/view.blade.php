                                    ...
                                    <ul class="nav nav-inline view_user_nav_padding">
                                        <li class="nav-item card_nav_hover">
                                            <a class="nav-link active" href="#user" id="home-tab"
                                               data-toggle="tab" aria-expanded="true">Detalles del cliente</a>
                                        </li>
                                        <li class="nav-item card_nav_hover">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="tab2">
                                            <table class="table" id="users">
                                                <tr role="row">
                                                    ...
                                                    <th>Monto</th>
                                                    <th>Moneda</th>
                                                </tr>{{--AQUI IRA EL CICLO FOR O LO QUE HAGA QUE SE MUESTREN TODOS LOS PROYECTOS QUE TIENE EL CLIENTE--}}
                                                <tr>
                                                    <td>Proyecto1</td>
                                                    <td>Cotizado</td>
                                                    <td>$164,579.00</td>
