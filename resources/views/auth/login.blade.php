...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/dashboard/animate.css"/>
    <!--End of Plugin styles-->
    <link type="text/css" rel="stylesheet" href="/css/dashboard/login1.css"/>
</head>
<body>
...
z-index: 999999">
        <img src="/img/dashboard/loader.gif" style=" width: 40px;" alt="loading...">
    </div>
</div>
                        ...
                        <form action="{{route('login')}}" id="login_validator" method="post" class="login_validator">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control  form-control-md" id="email" name="email" placeholder="Correo">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" class="form-control form-control-md" id="password"   name="password" placeholder="Contraseña">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="row">
...
<script type="text/javascript" src="/js/dashboard/tether.min.js"></script>
...
<script type="text/javascript" src="/js/dashboard/wow.min.js"></script>
<!--End of plugin js-->
<script type="text/javascript" src="/js/dashboard/login1.js"></script>
</body>
